...
| Self-hosting capability | materially improved | `internal/ProductOS-Next/` plus release, improvement, and workspace registration records make ProductOS operate as its own product. |
