...
| Self-hosting capability | materially improved | `workspaces/productos-v2/` plus release, improvement, and workspace registration records make ProductOS operate as its own product. |
