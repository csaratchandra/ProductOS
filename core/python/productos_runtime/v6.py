        ...
        "scenarios": [
            {
                ...
                "evidence_refs": [
                    ...
                    "workspaces/productos-v2/docs/delivery/lifecycle-release-readiness-review.md",
                ],
            ...
            },
            {
                ...
                "evidence_refs": [
                    ...
                    "workspaces/product-starter/docs/delivery/release-readiness-review.md",
                ],
            ...
            },
            {
                ...
                "evidence_refs": [
                    ...
                    "workspaces/productos-v2/feedback/2026-03-23-design-and-architecture-review.md",
                ],
            ...
            },
            {
                ...
                "evidence_refs": [
                    workspace_item["item_lifecycle_state_id"],
                    starter_item["item_lifecycle_state_id"],
                    "workspaces/productos-v2/docs/planning/v6-candidate-note.md",
                ],
    ...
    ralph_loop_state = {
        ...
        "stages": [
            ...
            },
            {
                ...
                "evidence_refs": [
                    runtime_scenario_report["runtime_scenario_report_id"],
                    "workspaces/productos-v2/docs/planning/v6-cutover-plan.md",
                ],
...
def summarize_v6_lifecycle_bundle(
    ...
    starter_item = load_item_lifecycle_state_from_workspace(
        _root_dir_from_workspace(workspace_dir) / "workspaces" / "product-starter"
    )
