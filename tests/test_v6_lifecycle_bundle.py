...
def test_build_v6_lifecycle_bundle_from_workspace_validates(bundled_workspace_dir: Path):
...
def test_v6_lifecycle_bundle_cross_refs(bundled_workspace_dir: Path):
    bundle = build_v6_lifecycle_bundle_from_workspace(
        bundled_workspace_dir,
        generated_at="2026-03-27T08:30:00Z",
    )
