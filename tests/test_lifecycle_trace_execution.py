...
def test_load_item_lifecycle_state_from_workspace(bundled_workspace_dir: Path):
    payload = load_item_lifecycle_state_from_workspace(
        bundled_workspace_dir,
        item_id="opp_pm_lifecycle_traceability",
    )

    assert payload["current_stage"] == "outcome_review"
...
def test_load_lifecycle_stage_snapshot_from_workspace(bundled_workspace_dir: Path):
...
def test_load_delivery_and_full_lifecycle_snapshots_from_workspace(bundled_workspace_dir: Path):
