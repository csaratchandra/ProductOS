...
- ensure the root README points PMs to `templates/`
- ensure the starter guide explains `init-workspace`
- use [v6-public-distribution-manifest.md](/Users/sarat/Documents/code/ProductOS/tests/fixtures/workspaces/productos-sample/docs/planning/v6-public-distribution-manifest.md) as the canonical include and exclude list for the public V6 repo
- tag the repo at `v6.0.0`
- push the commit and tag to the canonical remote

## PM Download Surface

- present `templates/` as the reusable starter
- present `tests/fixtures/workspaces/productos-sample/` as reference-only
