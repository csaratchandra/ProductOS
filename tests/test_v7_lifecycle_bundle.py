...
def test_build_v7_lifecycle_bundle_from_workspace_validates(bundled_workspace_dir: Path):
...
def test_v7_lifecycle_bundle_cross_refs(bundled_workspace_dir: Path):
    bundle = build_v7_lifecycle_bundle_from_workspace(
        bundled_workspace_dir,
        generated_at="2026-04-07T07:20:00Z",
    )
